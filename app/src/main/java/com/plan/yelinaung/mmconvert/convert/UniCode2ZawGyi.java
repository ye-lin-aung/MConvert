package com.plan.yelinaung.mmconvert.convert;
...
/**
 * Created by Zinetic on 8/16/15.
 */
public class UniCode2ZawGyi {
    public static String replace(String text, String text2) {
        int num, num2;
        JSONArray jsonArray;
        try {
            String text3;
            ...
            text2 = text3 = text2.replace((CharSequence) "null", (CharSequence) "\uffff\uffff");
            num2 = 0;
            ...
            do {
                String text4;
                if (num2 >= num) {
                    return text2.replace((CharSequence) "\uFFFF\uFFFF", (CharSequence) "null");
                }
                JSONObject jsonObject = jsonArray.getJSONObject(num2);
                text2 = text2.replaceAll(jsonObject.getString("from"), jsonObject.getString("to"));
                text2 = text4 = text2.replace((CharSequence) "null", (CharSequence) "");
                ++num2;
